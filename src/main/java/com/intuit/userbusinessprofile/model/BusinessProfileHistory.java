...
public class BusinessProfileHistory implements Serializable {
    ...
    @DynamoDBIndexHashKey(globalSecondaryIndexName = "ProfileIndex", attributeName = "profileId")
    ...
    @DynamoDBIndexRangeKey(globalSecondaryIndexName = "ProfileIndex", attributeName = "expiredOn")
